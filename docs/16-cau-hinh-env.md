...
| Biến | Ý nghĩa | Mặc định | Khi nào đổi |
|---|---|---|---|
| `JAVIS_CLAUDE_IDLE_TIMEOUT` | Thời gian chờ tối đa khi engine IM LẶNG mà KHÔNG có tool nào đang chạy, tính bằng giây | `180` | Hiếm khi cần đổi - đây là lưới bắt phiên treo thật. |
| `JAVIS_CLAUDE_TOOL_TIMEOUT` | Trần chờ khi một TOOL đang chạy dở (render video, tách nền, build...), tính bằng giây | `3600` | Tác vụ tool chạy quá 1 tiếng (encode video dài, train model...) thì tăng lên. Thông báo lỗi cũng nhắc tên biến này. |
