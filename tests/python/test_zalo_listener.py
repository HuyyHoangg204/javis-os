"""Test listener Zalo liên tục (sidecar webhook). Chạy tay / CI:
    ...
    python tests/run.py zalo_listener
...
src = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
src_zl = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
src2 = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
check("dọn: loại chính câu dò ra khỏi kết quả",
      ...
      if (src2b := open(SERVER / "zalo_listener.py", encoding="utf-8").read()) else False)
...
src3 = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
src3b = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
src4 = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
src5 = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
main_src = open(SERVER / "main.py", encoding="utf-8").read()
...
src7 = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
js = open(ROOT / "dashboard/console.js", encoding="utf-8").read()
...
src8 = open(SERVER / "zalo_listener.py", encoding="utf-8").read()
...
psrc = open(ROOT / "system/plugins/zalo-send/plugin.py", encoding="utf-8").read()
...
cmd = open(ROOT / "CLAUDE.md", encoding="utf-8").read()
